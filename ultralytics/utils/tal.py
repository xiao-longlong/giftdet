...
class TaskAlignedAssigner(nn.Module):
    ...
    def select_topk_candidates(self, metrics, largest=True, topk_mask=None):
        ...
        Args:
            ...
            topk_mask (torch.Tensor): An optional boolean tensor of shape (b, max_num_obj, topk), where topk is the
                number of top candidates to consider. If not provided, the top-k values are automatically computed based
    ...
    def get_targets(self, gt_labels, gt_bboxes, target_gt_idx, fg_mask):
        ...
        Returns:
            ...
            target_bboxes (torch.Tensor): Shape (b, h*w, 4), containing the target bounding boxes for positive anchor
                points.
            target_scores (torch.Tensor): Shape (b, h*w, num_classes), containing the target scores for positive anchor
                points.
        """
