...
class Results(SimpleClass, DataExportMixin):
    ...
    This class provides methods for accessing, manipulating, and visualizing inference results from various Ultralytics
    models, including detection, segmentation, classification, and pose estimation.
...
class OBB(BaseTensor):
    ...
    normalization, and access to various properties of the boxes.
