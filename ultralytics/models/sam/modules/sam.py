...
class SAM2Model(torch.nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            use_signed_tpos_enc_to_obj_ptrs (bool): Whether to use signed distance (instead of unsigned absolute
                distance) in the temporal positional encoding in the object pointers, only relevant when both
    ...
    def _forward_sam_heads(
        ...
        Returns:
            ...
            object_score_logits: Tensor of shape (B) with object score logits. Where M is 3 if multimask_output=True,
                and 1 if multimask_output=False.
